...
<body>
	<div class="main-container">
		...
		<div class="manage-employee details">
			...
			<a href="book-ap/create.php" class="button-one">Add Booking</a>
            <a href="book-ap/read.php" class="button-one">Read & Update Previous bookings</a>
            <a href="book-ap/delete.php" class="button-one">Delete booking </a>
        	</div>
		</div>
